...
class M_partner extends CI_model {
  ...
  */
	...
	var $table = 'partner';
  var $column_order = array('partner_category_id', 'name', 'phone_no', 'email', 'website', 'address', 'description', 'city', 'province', 'thumbnail', 'logo', 'maps');
  var $column_search = array('name', 'phone_no', 'email', 'website', 'address', 'description', 'city', 'province', 'thumbnail', 'logo', 'maps');
